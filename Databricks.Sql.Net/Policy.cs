...
namespace Databricks.Sql.Net
{
    ...
    public class Policy
    {
        ...
        => InternalExecuteAsync(new Func<Task<TResult>>(() => operation(cancellationToken)), arg, cancellationToken);
        ...
        /// </summary>
        public static Policy RetryForever() => WaitAndRetry(-1, TimeSpan.Zero, null, null);

        /// <summary>
        /// Gets a policy retrying forever with no delay and a predicate used to define whether a policy handles a given exception
        /// </summary>
        public static Policy RetryForever(Func<Exception, object, bool> isRetriable,
        ...
        /// </summary>
        public static Policy Retry(int retryCount = 1) => WaitAndRetry(retryCount, TimeSpan.Zero);
        ...
        /// </summary>
        public static Policy Retry(int retryCount, Func<Exception, object, bool> isRetriable,
                                                       Func<Exception, int, TimeSpan, object, Task> onRetry = null)
        ...
        /// </summary>
        public static Policy WaitAndRetryForever(TimeSpan sleepDuration = default)
        ...
        /// </summary>
        public static Policy WaitAndRetryForever(Func<int, TimeSpan> sleepDurationProvider,
        ...
        /// </summary>
        public static Policy WaitAndRetry(int retryCount, TimeSpan sleepDuration = default)
        ...
        /// </summary>
        public static Policy WaitAndRetry(int retryCount, TimeSpan sleepDuration,
                                Func<Exception, object, bool> isRetriable,
                                Func<Exception, int, TimeSpan, object, Task> onRetry = null)
        ...
        /// </summary>
        public static Policy WaitAndRetry(int retryCount, Func<int, TimeSpan> sleepDurationProvider,
                                                              Func<Exception, object, bool> isRetriable,
                                                              Func<Exception, int, TimeSpan, object, Task> onRetry = null)
        {
